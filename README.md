...
<h1 align="center">Christian Arévalo</h1>

<p align="center">
  <strong>Ingeniero de Sistemas e Informática</strong><br/>
  Construyo plataformas para instituciones públicas y educativas del Perú · Docente universitario · Fundador de <a href="https://devcloud.pe">DEVCLOUD&nbsp;EIRL</a>
</p>
...
|----------|-------------|-------------|
| **gestion-documental-posgrado** 🔒 | Sistema de gestión documental académico‑administrativo de la Escuela de Postgrado UNAP: expedientes, plazos, observaciones y firmas | Go, TypeScript, PostgreSQL, Docker |
| **elecciones-unap** 🔒 | Gestión electoral universitaria conforme al Reglamento N.º 048‑2026‑CU‑UNAP y al Manual de la ONPE | NestJS 11, Prisma 7, PostgreSQL 17, Docker |
| **portafolio-docente-unap** 🔒 | Plataforma multitenant de portafolio, evidencias y evaluación del desempeño docente en la UNAP | Django, Celery, Redis, MinIO (S3) |
| **whatsapp-facturacion** 🔒 | Facturación electrónica SUNAT con bot conversacional de WhatsApp: el cliente pide su factura por chat y recibe el PDF | Django, Baileys (Node), SUNAT, PostgreSQL |
| **geopapeleta** 🔒 | App Android para gestión y monitoreo georreferenciado de papeletas de salida: autorización digital, geocerca y evidencia fotográfica | Kotlin, CameraX, Google Maps |
| **devcloud-academy** 🔒 | Plataforma de gestión para academia de cursos: catálogo, ventas, inscripciones, seguimiento académico y B2B | Express 5, TypeScript, Kysely, Angular 22 |
| **culqi-kit** 🔒 | Mini‑SDK portable de Culqi v2 sin dependencias: cargos con 3DS, órdenes Yape y verificación segura de webhooks | TypeScript, Fetch API |
| [**itinerario**](https://github.com/carevalojesus/itinerario) | PWA de itinerario de viaje en tiempo real: checks compartidos por WebSocket, álbum de fotos y notificaciones push | Astro, React, Cloudflare Workers, R2 |
| [**eventosYA**](https://github.com/carevalojesus/eventosYA) ⭐ | Venta y validación de tickets digitales con Google Wallet y escaneo QR | Kotlin, Firebase, Cloud Functions |
| [**chatbot-whatsapp**](https://github.com/carevalojesus/chatbot-whatsapp) | Bot de pedidos para restaurante vía WhatsApp con carta, comprobante PDF con QR y comandos de administración | TypeScript, OpenWA, Firestore |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/carevalojesus)
[![Web](https://img.shields.io/badge/Web-devcloud.pe-05122A?style=for-the-badge)](https://devcloud.pe)
[![ORCID](https://img.shields.io/badge/ORCID-0000--0002--3602--8545-A6CE39?style=for-the-badge&logo=orcid&logoColor=white)](https://orcid.org/0000-0002-3602-8545)
[![Email](https://img.shields.io/badge/Email-carevalojesus@gmail.com-d14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:carevalojesus@gmail.com)
